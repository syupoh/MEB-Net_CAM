...
def main():
    ...
    # model_unet.cuda()
    #
    # model_incep = meb_models.create("inceptionv3", num_features=0, dropout=0, num_classes=751)
    # grad_cam_incep = GradCam(model=model_incep, feature_module=model_incep.base[17],
    #                          target_layer_names=["branch3x3dbl_3b"], use_cuda=args.use_cuda)
    # model_incep.cuda()
    #
    # model_den = meb_models.create("densenet", num_features=0, dropout=0, num_classes=751)
    # grad_cam_den = GradCam(model=model_den, feature_module=model_den.base[0][10],
    #                        target_layer_names=["denselayer16"], use_cuda=args.use_cuda)
    # model_den.cuda()
